...
<div class="container">
   ...
   <h3 class="title"> Televison & LEDs</h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/LED_LED.png') }}" alt="">
         <h3>LCD & LED Repairing</h3>
      </div>

      <div class="product" data-name="p-2">
      <img src="{{ asset('images/display_screen.png') }}" alt="">
      ...
      <img src="{{ asset('images/powersupply.png') }}" alt=""style="height: 250px; width: 250px ">
        
         <h3>Power Supply/Tv Dead</h3>
         
      </div>

      <div class="product" data-name="p-5">
      <img src="{{ asset('images/tv_installation.png') }}" alt=""style ="height: 300px; width: 350px ">
      
         <h3>Installation & Uninstalltion</h3>
         
      </div>

      <div class="product" data-name="p-6">
      <img src="{{ asset('images/notsure.png') }}" alt=""style="height: 250px; width: 250px ">
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <img src="{{ asset('images/LED_LED.png') }}" alt=""style ="height: 300px; width: 300px ">
      <h3>LCD & LED Repairing </h3>
      <div class="stars">
      ...
      <div class="buttons">
      <a href="{{ url('/service2/post') }}" class="buy">Book Service</a>
   ...
   <div class="preview" data-target="p-3">
      <i class="fas fa-times"></i>
      <img src="{{ asset('images/speaker.png') }}" alt=""style ="height: 300px; width: 300px ">
      <h3>Speaker/Sound</h3>
      <div class="stars">
         <i class="fas fa-star"></i>
         <i class="fas fa-star"></i>
