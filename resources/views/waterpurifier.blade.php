...
<div class="container">
   ...
   <h3 class="title"> RO Repairing Servicing Purchase </h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/RO.png') }}" alt="">
         <h3>All Type RO Servicing</h3>
      </div>

      <div class="product" data-name="p-2">
      <img src="{{ asset('images/RO_Repairing.png') }}" alt="">
        
         <h3>All Type RO Repairing</h3>
         
      </div>

      <div class="product" data-name="p-3">
      <img src="{{ asset('images/RO_purchase.png') }}" alt="">
         
         <h3>All Type RO Purchase Enquiry</h3>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <div class="buttons">
      <a href="{{ url('/service3/post') }}" class="buy">Book Service</a>
