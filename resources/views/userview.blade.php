        ...
        <div class="container">
            <div class="navbar">
                ...
                <nav>
                    <ul id="MenuItems">
                        ...
                        <li><a href="{{ url('/profilepage') }}" class="menu-item" data-key="account">Profile</a></li>
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <p id="intro-text">Success isn't always about greatness. It's about consistency. Consistent hard
