...
<div class="container">
   ...
   <h3 class="title"> All Carpentry Services </h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/drill.png') }}" alt="">
         <h3>Drill & Hanging</h3>
      </div>
      ...
      <img src="{{ asset('images/designing.png') }}" alt="">
         ...
         <h3>Designing_wooden_items</h3>
         
      </div>

      <div class="product" data-name="p-3">
      <img src="{{ asset('images/repairingwoodenitems.png') }}" alt="">
      <h3>repairing_wooden_items</h3>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <div class="buttons">
      <a href="{{ url('/service4/post') }}" class="buy">Book Service</a>
