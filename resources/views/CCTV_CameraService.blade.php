...
<div class="container">
   ...
   <h3 class="title"> CCTV Camera Repair Service </h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/CCTV Camera Repairing.png') }}" alt="">
         <h3>CCTV Camera Repairing</h3>
      </div>

      <div class="product" data-name="p-2">
      <img src="{{ asset('images/CCTV Camera Servicing.png') }}" alt="">
        
         <h3>CCTV Camera Servicing</h3>
         
      </div>

      <div class="product" data-name="p-3">
      <img src="{{ asset('images/CCTV Camera Installation1.png') }}" alt="">
      ...
      <img src="{{ asset('images/CCTV Camera Uninstallation.png') }}" alt=""style="height: 250px; width: 250px ">
        
         <h3>CCTV Camera Uninstallation</h3>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <div class="buttons">
      <a href="{{ url('/service9/post') }}" class="buy">Book Service</a>
