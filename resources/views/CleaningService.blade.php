...
<div class="container">
   ...
   <h3 class="title"> Home Cleaning Services</h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/Bathroom Cleaning.png') }}" alt="">
         <h3>Bathroom Cleaning</h3>
      </div>

      <div class="product" data-name="p-2">
      <img src="{{ asset('images/Kitchen Cleaning.png') }}" alt="">
         <h3>Kitchen Cleaning</h3>
         
      </div>

      <div class="product" data-name="p-3">
      <img src="{{ asset('images/Room Cleaning.png') }}" alt="">
         <h3>Room Cleaning</h3>
         
      </div>

      <div class="product" data-name="p-4">
      <img src="{{ asset('images/Outside Home Cleaning.png') }}" alt=""style="height: 250px; width: 250px ">
         <h3>Outside Home Cleaning</h3>
         
      </div>

      <div class="product" data-name="p-5">
      <img src="{{ asset('images/FLat Cleaning Services.png') }}" alt=""style ="height: 300px; width: 350px ">
         <h3>FLat Cleaning Services</h3>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <div class="buttons">
      <a href="{{ url('/service10/post') }}" class="buy">Book Service</a>
