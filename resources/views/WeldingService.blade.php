...
<div class="container">
   ...
   <h3 class="title"> Welding Services </h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/Welding Services.png') }}" alt="">
         <h3>Welding</h3>
      </div>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <img src="{{ asset('images/Welding Services.png') }}" alt=""style="height: 300px; width: 300px ">
         <h3>Welding</h3>
      <div class="stars">
      ...
      <div class="buttons">
      <a href="{{ url('/service12/post') }}" class="buy">Book Service</a>
