...
<div class="container">
   ...
   <h3 class="title"> All Interior Services </h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/Home Decor.png') }}" alt="">
         <h3>Home Decor</h3>
      </div>

      <div class="product" data-name="p-2">
      <img src="{{ asset('images/Office Decor.png') }}" alt="">
      <h3>Office Decor</h3>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <img src="{{ asset('images/Home Decor.png') }}" alt=""style="height: 300px; width: 300px ">
         <h3>Home Decor</h3>
      <div class="stars">
      ...
      <div class="buttons">
      <a href="{{ url('/service11/post') }}" class="buy">Book Service</a>
