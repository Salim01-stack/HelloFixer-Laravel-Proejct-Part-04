...
<div class="container">
   ...
   <h3 class="title"> Inverter And Battery </h3>
   ...
   <div class="products-container">
      ...
      <img src="{{ asset('images/inverter.png') }}" alt="">
         <h3>Inverter Repairing</h3>
      </div>

      <div class="product" data-name="p-2">
      <img src="{{ asset('images/Battery_Repairing.png') }}" alt="">
      <h3>Battery Repairing</h3>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
      ...
      <img src="{{ asset('images/inverter.png') }}" alt=""style="height: 300px; width: 300px ">
         <h3>Inverter Repairing</h3>
      <div class="stars">
      ...
      <div class="buttons">
      <a href="{{ url('/service7/post') }}" class="buy">Book Service</a>
